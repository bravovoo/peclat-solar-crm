...
export const roleDefinitions = [
  ...
  ['seller', 'Vendedor', ['dashboard.read', 'crm.own', 'contracts.own', 'contracts.create', 'contracts.edit', 'contracts.payments.read', 'installations.read', 'installations.create', 'installations.edit', 'post_sales.read', 'post_sales.create', 'whatsapp.use']],
