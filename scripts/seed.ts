...
export const roleDefinitions = [
  ['admin', 'Administrador', ['dashboard.read', 'team.read', 'commercial_team.read', 'commercial_team.manage', 'settings.read', 'audit.read', 'crm.all', 'crm.own', 'crm.duplicate.override', 'crm.delete', 'crm.tags.manage', 'solar.catalog.manage', 'contracts.all', 'contracts.own', 'contracts.create', 'contracts.edit', 'contracts.cancel', 'contracts.payments.read', 'contracts.payments.manage', 'installations.read', 'installations.create', 'installations.edit', 'installations.manage', 'post_sales.read', 'post_sales.create', 'post_sales.edit', 'post_sales.manage', 'whatsapp.use', 'postsales.read']],
  ['manager', 'Gerente Comercial', ['dashboard.read', 'team.read', 'commercial_team.read', 'commercial_team.manage', 'crm.all', 'crm.own', 'crm.duplicate.override', 'crm.delete', 'solar.catalog.manage', 'contracts.all', 'contracts.own', 'contracts.create', 'contracts.edit', 'contracts.cancel', 'contracts.payments.read', 'contracts.payments.manage', 'installations.read', 'installations.create', 'installations.edit', 'installations.manage', 'post_sales.read', 'post_sales.create', 'post_sales.edit', 'post_sales.manage', 'whatsapp.use']],
  ['seller', 'Vendedor', ['dashboard.read', 'commercial_team.read', 'crm.own', 'contracts.own', 'contracts.create', 'contracts.edit', 'contracts.payments.read', 'installations.read', 'installations.create', 'installations.edit', 'post_sales.read', 'post_sales.create', 'whatsapp.use']],
