...
function fact(overrides:Partial<LeadFact>={}):LeadFact{return {id:crypto.randomUUID(),name:'Lead fictício',stage:'contact',status:'active',owner_id:crypto.randomUUID(),owner_name:'Vendedor',created_at:'2026-09-01T12:00:00Z',updated_at:'2026-09-20T12:00:00Z',phone:'+5531999990000',consent_status:'opted_in',consent_source:'Formulário',consent_version:1,service_started_at:null,service_source:'',conversation_id:null,automations_paused:false,automation_blocked:false,last_inbound_at:null,last_manual_outbound_at:'2026-09-20T12:00:00Z',last_commercial_activity_at:null,future_task_at:null,has_won_opportunity:false,has_lost_opportunity:false,has_accepted_proposal:false,owner_active:true,enrollment_id:null,enrollment_status:null,enrollment_version:null,attempt_count:null,next_attempt_at:null,state_reason:null,...overrides};}
