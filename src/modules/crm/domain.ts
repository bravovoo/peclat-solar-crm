...
export const sources=['WhatsApp','WhatsApp Flow','Instagram','Facebook','Google','Google Ads','Meta Ads','Indicação','Site','Formulário','Ligação','Prospecção','Parceiro','Importação','Manual','Outro'];
