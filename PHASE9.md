...
- O consentimento explícito verificável permanece obrigatório. A captura automática registra respostas afirmativas com contexto ou um OptIn válido; não presume autorização a partir do primeiro contato e não envia pedidos automáticos de autorização. Pedidos/opções com negação são rejeitados como evidência positiva.
